...
class Answer(val ans: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val pdf = view.findViewById<PDFView>(R.id.pdfViewA)
        FileLoader.with(activity)
            ...
            .asFile(object : FileRequestListener<File> {
                override fun onLoad(
                    ...
                    pdf.fromFile(pdfFile).password(null)
                        ...
                        .onRender { nbPages, pageWidth, pageHeight ->
                            view.findViewById<PDFView>(R.id.pdfViewA).fitToWidth()
                        }
                ...
                override fun onError(request: FileLoadRequest?, t: Throwable?) {
                    if (t != null) {
                        view.findViewById<TextView>(R.id.noDataA).visibility = View.VISIBLE
                    }
                }
            })
